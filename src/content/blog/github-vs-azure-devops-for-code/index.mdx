...
image: "./github-vs-azure-devops-for-code.png"
tags:
  - github
  - azure-devops
---
...
![Code Scanning Alerts](./code-scanning-alerts.png)
...
![Development links in the Jira issue details](./jira-development.png)
![GitHub Branches](./jira-branches.png)
![GitHub Commits](./jira-commits.png)
![GitHub PRs](./jira-prs.png)
...
![GitHub Mobile App](./app_GitHub.png)
...
- Import repository
  ![Import repository](./import-repo.png)
...
- And on the next screen, it will ask for credentials to access your DevOps repo. `Git credentials` for the Azure DevOps repo will work fine. You can generate that one on the clone window on Azure DevOps as shown below.
  ![Azure DevOps > Git Credentials](./git-credentials.png)
