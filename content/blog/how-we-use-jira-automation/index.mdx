...
image: "./how-we-use-jira-automation.png"
tags:
  - jira
  - project-management
---
...
![Auto-assign to whoever created the issue](./auto-assign-to-whoever-created-the-issue-1.png)

And the result will be,

![Automation auto assigned to reporter](./1-auto-assign-to-whoever-created-the-issue-result.png)
...
![Link issue as duplicates](./close-duplicate-issues-1.png)

The automation rule for closing such duplicate is,

![Trigger - Close duplicate issues](./close-duplicate-issues-2.png)

That will do,

![Duplicate issue closed by automation](./2-close-duplicate-issues-result.png)
...
![Trigger - Link issues that are mentioned in the comments](./link-issues-that-are-mentioned-in-the-comments-1.png)
![Check whether any issue mentioned in the comments](./link-issues-that-are-mentioned-in-the-comments-2.png)
![Link the mentioned issue](./link-issues-that-are-mentioned-in-the-comments-3.png)

The result is,

![Automation links the commented issue](./link-issues-that-are-mentioned-in-the-comments-result.png)
...
![Trigger - When a commit is created and the status is 'To do' → then transition this issue to 'In Dev'](./when-a-commit-is-created-and-the-status-is-to-do-then-transition-this-issue-to-in-dev-1.png)

That's it, automation will take care of the issue transition,

![Issue transition](./when-a-commit-is-created-and-the-status-is-to-do-then-transition-this-issue-to-in-dev-result.png)
...
![Comment - On Pull Request created → comment the details](./on-pull-request-created-comment-the-details-1.png)

Then automation will do,

![Comments PR details when PR created](./on-pull-request-created-comment-the-details-result.png)
...
![Comment - On Pull Request merged → comment the details](./on-pull-request-merged-comment-the-details-1.png)

Then automation will do,

![Comments PR details when PR merged](./on-pull-request-merged-comment-the-details-result.png)
...
![Scheduled trigger](./comment-on-ready-for-qa-items-if-not-assigned-to-a-qa-1.png)
![Comment](./comment-on-ready-for-qa-items-if-not-assigned-to-a-qa-2.png)

That's it, automation will notify the developer in case they forgot to assign the task to a QA person.

![Automation comment](./comment-on-ready-for-qa-items-if-not-assigned-to-a-qa-result.png)
...
![Change assignee](./assign-issue-back-to-developer-once-ready-to-deploy-1.png)

Now automation will take care of the assignee switching,

![Assignee changed](./assign-issue-back-to-developer-once-ready-to-deploy-result.png)
...
![Condition](./assign-issue-back-to-developer-once-done-1.png)
...
![Comment on related issues](./when-issue-is-resolved-comment-on-related-issues-1.png)

This rule does,

![Commented on related issue](./10-when-issue-is-resolved-comment-on-related-issues-result.png)
...
![Label issues as stale that have not had recent interaction](./label-issues-as-stale-that-have-not-had-recent-interaction-1.png)
