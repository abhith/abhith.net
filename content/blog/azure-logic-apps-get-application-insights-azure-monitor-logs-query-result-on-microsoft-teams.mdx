...
description: >-
  Use Azure Logic Apps to create your daily reports from Application Insights or from Azure Monitor Logs and receive it on Microsoft Teams.
author: Abhith Rajan
...
![Application Insights - Performance](../../static/img/blog/azure-logic-apps-get-application-insights-azure-monitor-logs-query-result-on-microsoft-teams/sample-card.png)
...
### Card with a list of items - 1

![Application Insights - Performance](../../static/img/blog/azure-logic-apps-get-application-insights-azure-monitor-logs-query-result-on-microsoft-teams/card-with-list-of-items-1.png)
...
When fed with the data, the result looks like,

![Application Insights - Performance](../../static/img/blog/azure-logic-apps-get-application-insights-azure-monitor-logs-query-result-on-microsoft-teams/app-insights-performance.png)

### Card with a list of items - 2

![Application Gateway - Failed Requests](../../static/img/blog/azure-logic-apps-get-application-insights-azure-monitor-logs-query-result-on-microsoft-teams/card-with-list-of-items-2.png)
...
Notice the `@{variables('rows')}`, that's where magic happens. So the array we prepared in the previous step gets appended here hence we get to see the multiple rows in the adaptive card.
