...
Azure is my favorite cloud provider. We kind of relying upon Azure for most of the infra & services.
Our code goes to [Azure DevOps](/topics/azure-devops/), we use **Azure Container Registry (ACR)** to host our docker container images and our Kubernetes clusters running in [Azure Kubernetes Service (AKS)](/topics/aks/).
